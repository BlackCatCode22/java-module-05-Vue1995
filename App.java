...
public class App {
    ...
    private static String calcAnimalBirthDate(int age, String theSeason) {
        ...
        animalBirthdate = switch (season) {
            case "spring" -> Integer.toString(animalBirthYear) + "-03-21";
            case "fall" -> Integer.toString(animalBirthYear) + "-09-21";
            case "winter" -> Integer.toString(animalBirthYear) + "-12-21";
            case "summer" -> Integer.toString(animalBirthYear) + "-06-21";
            default -> Integer.toString(animalBirthYear) + "-01-01"; // Default case for anything else
        };
