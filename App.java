...
public class App {
    ...
    public static void main(String[] args) {
        ...
        sheena.zoo.com.AnimalNameListsWrapper animalLists = sheena.zoo.com.Utilities.createAnimalNameLists(filePath);
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (aniSpecies.equals("hyena")) {
                    ...
                    sheena.zoo.com.Hyena hyena = new sheena.zoo.com.Hyena(aniSex, intAniAge, 99, "to be named",
                ...
                sheena.zoo.com.Animal myNewAnimal = new sheena.zoo.com.Animal("male", 4, 70, "Zig", "Hy01", "2020-3-21", "brown spots", "from San Diego Zoo");

                // Prove it!
                System.out.println("\n this is the new animal!\n");
                System.out.println("\n ID is: " + myNewAnimal.getAnimalID() + " and... name is: " + myNewAnimal.getAnimalName() + "\n");

                System.out.println("animal birthdate is: " + sheena.zoo.com.Utilities.calcAnimalBirthDate(Integer.parseInt(ageInYears), animalBirthSeason));
